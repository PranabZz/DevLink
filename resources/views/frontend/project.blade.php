        ...
        <div class="container">
            ...
            <ul class="feature-list">
                @foreach ($projects as $project)
                    <li>
                        <a
                            href="{{ route('project.view', [$project->project_slug, $project->project_id, $project->user_id]) }}">
        ...
        <div class="feature-bg">
            <svg width="541" height="993" viewBox="0 0 541 993" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    ...
                    <linearGradient id="paint0_linear_42_1703" x1="280.327" y1="743" x2="824.387" y2="665.359"
